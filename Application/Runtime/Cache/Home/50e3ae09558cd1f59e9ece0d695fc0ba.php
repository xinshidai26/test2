    ...
    <div class="myapp-login-logo-block">
            ...
            <form method="post" action="#" class="am-form">
                <fieldset>
                    <div class="am-form-group">
                        <input type="text" class="user_name input_text_color" placeholder="请输入账号名">
                    </div>
        ...
        <div class="am-u-sm-10 login-am-center sign_choose" style="display: none; float:initial">
            <form method="post" action="#" class="am-form">
                <fieldset>
                    <div class="am-form-group">
                        <input type="text" class="user_name input_text_color" placeholder="请注册新账户名">
                    </div>
                    ...
                    <div class="am-form-group">
                        <input type="text" class="user_nickname input_text_color" placeholder="请输入昵称">
                    </div>
